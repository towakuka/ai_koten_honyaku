module.exports = {
  title: '知られぬ日本の面影 第二集', // populated into `publication.json`, default to `title` of the first entry or `name` in `package.json`.
  author: 'ラフカディオ・ハーン', // default to `author` in `package.json` or undefined.

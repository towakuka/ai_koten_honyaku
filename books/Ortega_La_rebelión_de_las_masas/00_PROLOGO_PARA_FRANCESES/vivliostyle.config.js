module.exports = {
  title: '大衆の反逆', // populated into `publication.json`, default to `title` of the first entry or `name` in `package.json`.
  author: 'オルテガ', // default to `author` in `package.json` or undefined.

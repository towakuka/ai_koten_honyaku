module.exports = {
  title: '経済学原理', // populated into `publication.json`, default to `title` of the first entry or `name` in `package.json`.
  author: 'アルフレッド・マーシャル', // default to `author` in `package.json` or undefined.
  ...
  entry: [
    ...
    // {
    //   path: 'epigraph.md',
    //   title: '経済学原理', // title can be overwritten (entry > file),

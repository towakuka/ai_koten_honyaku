module.exports = {
  title: '有閑階級の理論', // populated into `publication.json`, default to `title` of the first entry or `name` in `package.json`.
  author: 'ヴェブレン', // default to `author` in `package.json` or undefined.

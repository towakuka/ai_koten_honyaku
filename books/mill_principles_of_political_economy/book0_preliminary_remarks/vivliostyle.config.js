module.exports = {
  title: '経済学および課税の原理', // populated into `publication.json`, default to `title` of the first entry or `name` in `package.json`.
  author: 'リカード', // default to `author` in `package.json` or undefined.
